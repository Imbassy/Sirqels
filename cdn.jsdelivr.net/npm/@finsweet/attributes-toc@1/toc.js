...
(() => {
  ...
  var Ve = (t, e, r) => (
    ...
    $e(
      e || !t || !t.__esModule
        ? k(r, "default", { value: t, enumerable: !0 })
        : r,
      t
    )
  );
  ...
  var Se = Pe((q, X) => {
    (function (t, e, r) {
      typeof q == "object"
        ? ((X.exports = r()), (X.exports.default = r()))
        ...
        var s = e[o.locale] || {},
          ...
          a = n
            ...
            .reduce(function (p, l) {
              ...
              return (
                u === i && (u = " "),
                p + u.replace(o.remove || /[^\w\s$*_+~.()'"!\-:@]+/g, "")
              );
            }, "");
        return (
          o.strict && (a = a.replace(/[^A-Za-z0-9\s]/g, "")),
          c && (a = a.trim()),
          (a = a.replace(/\s+/g, i)),
          o.lower && (a = a.toLowerCase()),
          a
        );
      }
      return (
  ...
  var w = class {
    constructor({ element: e, duration: r }) {
      d(this, "element");
      d(this, "active", !1);
      d(this, "running", !1);
      ...
      (this.element =
        typeof e == "string"
          ? V(e, HTMLElement) ||
            I.alert(`No interaction with the ${e} selector was found.`, "error")
          : e),
        (this.duration = {
          first:
            typeof r == "number"
              ? r
              : (n = r == null ? void 0 : r.first) != null
              ? n
              : 0,
          second:
            typeof r == "number"
              ? r
              : (o = r == null ? void 0 : r.second) != null
              ? o
              : 0,
        });
    }
    async trigger(e) {
      return (e === "first" && this.active) || (e === "second" && !this.active)
        ...
        : (e || (e = this.active ? "second" : "first"),
          M(this.element, "click"),
          (this.running = !0),
          (this.runningPromise = ne(this.duration[e])),
  ...
  var G = async (t) => {
    ...
    if (
      ...
      if ((t || (e.destroy(), e.ready()), !t || t.includes("ix2"))) {
        let o = e.require("ix2");
        if (o) {
          let { store: s, actions: i } = o,
            { eventState: c } = s.getState().ixSession,
            a = Object.entries(c);
          t || o.destroy(),
            o.init(),
            await Promise.all(
              a.map((p) => s.dispatch(i.eventStateChanged(...p)))
            );
        }
      }
      if (!t || t.includes("commerce")) {
        ...
        o &&
          s &&
          (o.destroy(),
          o.init({ siteId: s, apiUrl: "https://render.webflow.com" }));
      }
      if (
        (t != null &&
          t.includes("lightbox") &&
          ((r = e.require("lightbox")) == null || r.ready()),
        t != null && t.includes("slider"))
      ) {
  ...
  var Ge = `${b}-${B}`,
    ce = async () => {
      ...
      return !r.includes("webflow.io") || !n.has(Ge)
        ? !1
        : (o = t.import) == null
        ? void 0
        : o.call(t, B, "1");
  ...
  var le = ({ scriptAttributes: t, attributeKey: e, version: r, init: n }) => {
      var c;
      Fe(), (c = window.fsAttributes)[e] || (c[e] = {});
      let { preventsLoad: o, attributes: s } = ae(t),
  ...
  var T = `fs-${x}`,
    ...
    A = {
      element: {
        key: `${T}-element`,
        values: { contents: v(Xe), table: v(ze), link: v(Je), ixTrigger: Ze },
      },
      scrollMarginTop: { key: `${T}-${Qe}` },
      scrollMarginBottom: { key: `${T}-${et}` },
      hideURLHash: { key: `${T}-${tt}`, values: rt },
    },
    [S, E] = C(A),
    ue = 2,
    g = `${T}-anchor`,
    ...
    Ae = () => {
      ...
      let e = t.replace("#", ""),
        r = document.querySelector(
          `${S("element", "contents", { operator: "prefixed" })} [id="${e}"]`
        );
  ...
  var Ie = ({ children: t }) => {
      ...
      for (let r = t.length - 1; r >= 0; r--) {
        ...
        if (m != null && m.level) {
          let f = m.level - 1;
          if (p < f)
            for (let y = 1; y <= f - p; y++) e.unshift({ level: m.level - y });
        }
        ...
        e.unshift({ level: p, headingElement: o, headingWrapper: l, id: u });
      }
      return e;
    },
    _e = (t) => {
      let e = [],
        r = (n) => {
          ...
          let i = (u = e[e.length - 1]) == null ? void 0 : u.level,
            c = i ? i + 1 : ue;
          e.push({ linkElement: o, level: c, component: s });
          let p = [...s.querySelectorAll(`* ${S("element", "link")}`)].find(
            (m) => m !== n
          );
          if (!p) return s;
          let l = r(p);
  ...
  var we = (t, e) =>
    H(t, "click", (n) => {
      !te(n.target) ||
        ...
        e &&
          window.setTimeout(() => {
            let { origin: s, pathname: i, search: c } = window.location;
            history.replaceState("", document.title, s + i + c);
          }));
    });
  var Re = (t, e) => {
    let r = new MutationObserver((n) => {
      for (let { target: o } of n) {
        if (!re(o)) continue;
        let s = e.find(({ linkElement: i }) => i === o);
        s && s.updateState();
      }
    });
    return (
      r.observe(t, { attributes: !0, subtree: !0, attributeFilter: ["class"] }),
      r
    );
  };
  var N,
    ...
    U = class {
      constructor({
        ...
        (this.level = e),
          (this.linkWrapper = o),
          (this.referenceNode = p),
          (this.anchor = l),
          (this.component = r),
          (this.linkElement = n),
          (this.headingElement = s),
          (this.headingWrapper = i),
          (this.id = c),
          (this.ixTrigger = a),
          (this.interaction = a ? new w({ element: a }) : void 0),
          J(this, N, Le).call(this);
      }
      setScrollOffset(e) {
        let { headingWrapper: r } = this;
        r && Object.assign(r.style, e);
      }
      updateState() {
        let { linkElement: e, interaction: r, currentState: n } = this,
          o = e.classList.contains(oe);
        o !== n &&
          (r == null || r.trigger(o ? "first" : "second"),
          (this.currentState = o));
      }
    };
  (N = new WeakSet()),
    (Le = function () {
      ...
      e && r
        ? ((n.textContent = e.textContent), (o.href = `#${r}`))
        : o.remove(),
        s.insertBefore(i, c);
    });
  var Oe = (t, e, r) => {
    ...
    for (let s of t) {
      ...
      if (!i) continue;
      for (let f = o.length - 1; f >= 0 && !(s.level > o[f].level); f--)
        o.pop();
      let c = o[o.length - 1],
        a = (c == null ? void 0 : c.component) || r,
        p = P(i.component),
        l = E("link", { scope: p, operator: "prefixed" });
      if (!l) continue;
      let u = l.closest("a");
      if (!u) continue;
      let m = [...a.childNodes].find(
        ({ nodeType: f, nodeValue: y }) => f === 8 && y === g
      );
      if (!m) continue;
      let h = p.querySelector(
          `:scope > ${S("element", "ixTrigger", { operator: "prefixed" })}`
        ),
        L = new U({
          linkWrapper: a,
          component: p,
  ...
  var ve = ([{ component: t }], e) => {
    let r = E("table", { instanceIndex: e }) || t.parentElement;
    if (!r) return;
    let n = new Comment(g);
    return (
      t.parentElement === r ? r.insertBefore(n, t) : r.append(n), t.remove(), r
    );
  };
  var Ce = (t) => {
    let e = be(t, A.element.key),
      r = E("link", { instanceIndex: e });
    if (!r) return;
    let n = Ie(t),
      o = _e(r) || [];
    ...
    Te(i, { scrollMarginTop: c, scrollMarginBottom: a });
  ...
  var Ue = async () => {
    await ee(Z, Q);
    let e = E("contents", { operator: "prefixed", all: !0 }).map(Ce).filter(D);
    return (
      Ae(),
      e.length && (await G()),
      se(x, void 0, () => {
  ...
  le({ init: Ue, version: pe, attributeKey: x });
})();
